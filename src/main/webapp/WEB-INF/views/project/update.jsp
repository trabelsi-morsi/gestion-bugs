...
<t:Layout> 
    ...
    <jsp:body>
   			...
   			<h3 class="heading_b uk-margin-bottom">Edit Project</h3>
            <div class="md-card">
					         ...
					         <div class="uk-width-large-1-1">
					            <div class="parsley-row">
					                <label for="fullname">Title<span class="req">*</span></label>
					   				<input type="text" name="title" required class="md-input" value="${project.title}" /> 
					            </div>
					        </div> 
					    </div> 
					         ...
					         <div class="uk-width-large-1-1">
					            <div class="parsley-row">
					                <label for="fullname">Description<span class="req">*</span></label>
					   				<input type="text" name="description" required class="md-input" value="${project.description}" /> 
					            </div>
					        </div> 
					    </div>
                                ...
                                <div class="uk-width-large-1-2 uk-width-medium-1-1">
                                    <div class="uk-input-group">
                                        <span class="uk-input-group-addon"><i class="uk-input-group-icon uk-icon-calendar"></i></span>
	                                        ...
	                                        <input class="md-input" type="text" value="${project.date}" id="uk_dp_1" name="datee" data-uk-datepicker="{format:'YYYY-MM-DD'}">
