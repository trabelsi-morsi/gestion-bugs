...
<t:Layout> 
    ...
    <jsp:body>
		...
		<h3 class="heading_b uk-margin-bottom">List ScreenShot</h3>
		<div class="md-card">
					...
					<table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
						  <thead>
							  <tr>
								   ...
								   <th>Name</th>
								   <th class="filter-false remove sorter-false uk-text-center">Photo</th>
								  <th class="filter-false remove sorter-false uk-text-center" colspan="2" style="width: 50px;">Actions</th>
							  </tr>
						  </thead>
						<tbody>
							<c:forEach var="u" items="${allscreenShot}">
								<tr>
									...
									<td class="uk-text-small"> 
											<div class="chat_user_avatar"
												onclick="viewphotomodel('C:/gestion-bugs/screenShot/<c:out value="${u.photo}"/>')"
												data-uk-modal="{target:'#modal_lightbox'}">
	                                           <img class="md-user-image"
													src="${u.photo}"
													alt="${u.name}"  style="width: 50px;border-radius: 0px;">
	                                       </div>
									</td>  
		  ...
		  <div class="md-fab-wrapper">
			...
			<div class="uk-modal" id="modal_lightbox">
			    <di class="uk-modal-dialog uk-modal-dialog-lightbox">
