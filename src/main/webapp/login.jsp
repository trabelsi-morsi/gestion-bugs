...
<head>
    ...
    <link rel="icon" type="image/png" href="./resources/assets/img/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="./resources/assets/img/favicon-32x32.png" sizes="32x32">
    ...
    <!-- uikit -->
    <link rel="stylesheet" href="./resources/bower_components/uikit/css/uikit.almost-flat.min.css"/>

    <!-- altair admin login page -->
    <link rel="stylesheet" href="./resources/assets/css/login_page.min.css" />
...
<body class="login_page">
    ...
    <div class="login_page_wrapper">
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
				...
				<img src="./resources/assets/img/logo.png" style=" width: 130px; "> 
                </div>
                <form>
    ...
    <script src="./resources/assets/js/pages/login.min.js"></script>
